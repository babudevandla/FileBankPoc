			                		...
			                		<c:forEach items="${folderInfo.localFilesInfo}" var="files" varStatus="status">
						                <tr class="row100 body">
							                ...
							                <td class="cell100 column5">
							                    ...
							                    <a data-href="${contextPath}/sm/moveFilesAndFolders?sourceFolderId=${folderInfo.fId}&sourceFileId=${files.fileId}&moveType=${FileAndFolderMoveEnum.FILE_MOVE}" id="moveFilesWindow" class="table-link moveFilesWindowClas">
							                      <span class="fa-stack">
							                        <i class="fa fa-square fa-stack-2x"></i>
							                       <i class="fa fa-arrow-right  fa-stack-1x fa-inverse" aria-hidden="true"></i>
							                      </span>
