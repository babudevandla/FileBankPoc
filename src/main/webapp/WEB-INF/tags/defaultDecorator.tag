	     ...
	     <div class="container">
            ...
            <ul class="nav-news-feed">
             <%--  <li class="${digiLockActive?'active':''}"><i class="fa fa-dashboard"></i><div><a href="${contextPath}/sm/dashboard">Dashboard</a></div></li> --%>
              ...
              <li class="${digiLockActive?'active':''}"><i class="icon ion-images"></i><div><a href="${contextPath}/sm/getGallerContent">Gallery</a></div></li>
  ...
  <div class="modal fade" id="fileAndFolderMoveModelPopup" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content" style="width: 100%">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">You are moving selected File/Folder to Below location</h4>
        </div>
        <div class="modal-body" >
          <div id="moveFilesAndFoldersId" style=" margin-top: -15px"></div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" id="moveFileOrFolderSubmit" data-href="${contextPath}/sm/moveFileOrFolderSubmit" >Move Here</button>
            <button type="button" class="btn btn-primary"  data-dismiss="modal">Cancel</button>
        </div>
      </div>
